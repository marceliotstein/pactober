        ...
        <table class="ttable">
          <tr class="trow">
            ...
            <td class="xs-title-well">
              <h1 class="pac-front-title"><b>Pacifism<span class="pac-green-sh">.sh</span></h1>
              <p class="pac-front-descrip">An information resource</b> about a misunderstood philosophy. Launching in Spring 2015.</p>
            </td>
          </tr>
        </table>
      </div>
